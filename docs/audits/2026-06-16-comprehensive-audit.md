...
**Location:** [main.rs](../../src/main.rs) ~line 280
...
**Location:** [ffmpeg.rs](../../src/ffi/ffmpeg.rs) ~line 130
...
**Location:** [session.rs](../../src/app/session.rs)
...
**Location:** [session.rs](../../src/app/session.rs) ~line 1020
...
**Location:** [session.rs](../../src/app/session.rs) ~line 1120
...
**Location:** [window.rs](../../src/platform/window.rs), [main.rs](../../src/main.rs)
...
**Location:** [main.rs](../../src/main.rs) WndProc
...
**Location:** [d3d11.rs](../../src/ffi/d3d11.rs) ~line 2100
...
**Location:** [d3d11.rs](../../src/ffi/d3d11.rs) ~line 1720
...
**Location:** [timeline.rs](../../src/render/timeline.rs) ~line 250
...
**Location:** [sink.rs](../../src/audio/sink.rs) ~line 60
...
**Location:** [dxgi.rs](../../src/ffi/dxgi.rs) ~line 150
...
**Location:** [clock.rs](../../src/playback/clock.rs) ~line 35
...
**Location:** [subtitle.rs](../../src/media/subtitle.rs)
...
**Location:** [wasapi.rs](../../src/ffi/wasapi.rs) ~line 160
...
**Location:** [wasapi.rs](../../src/ffi/wasapi.rs) ~line 140
...
**Location:** [logging.rs](../../src/logging.rs)
...
**Location:** [input.rs](../../src/platform/input.rs)
...
**Location:** [d3d11.rs](../../src/ffi/d3d11.rs) ~line 2400
...
**Location:** [d3d11.rs](../../src/ffi/d3d11.rs)
...
[state.rs](../../src/app/state.rs) defines `Ended` but not `Draining`. ARCHITECTURE.md lists `Draining` as a distinct state. End-of-stream is currently handled via flags. Minor spec drift.
...
[presenter.rs](../../src/render/presenter.rs) recalculates the aspect ratio and rotation matrix on every `present_frame()` call. These values only change on resize or rotation change and should be cached.

### 28. No media key support
[input.rs](../../src/platform/input.rs) doesn't handle `VK_MEDIA_PLAY_PAUSE`, `VK_MEDIA_STOP`, etc.

### 29. Volume setting not connected
[settings.rs](../../src/app/settings.rs) has a `volume` field but it's not wired to the audio sink.

### 30. SRT HTML tags displayed literally
[subtitle.rs](../../src/media/subtitle.rs) doesn't strip `<b>`, `<i>`, `<font>` tags that are common in SRT files.

### 31. Dead code: `create_staging_texture()`
[d3d11.rs](../../src/ffi/d3d11.rs) has an unused `create_staging_texture()` function.

### 32. Surface registry uses `HashMap` instead of slot map
[surface_registry.rs](../../src/render/surface_registry.rs) — for the small number of live surfaces (typically <10), a `Vec`-based slot map would be faster. Minor optimization.
