...
[maintainer's GitHub profile](https://github.com/CalvinSturm). If a report
requires confidentiality and the repository's private reporting form is
available, use it and identify the submission as a Code of Conduct report. If
no private contact method is available, open a minimal issue requesting private
