...
**[Download FastPlay v0.4.3 for Windows x64](https://github.com/CalvinSturm/FastPlay/releases/download/v0.4.3/fastplay-0.4.3-x86_64.msi)** • [All releases](../../releases) • [Report an issue](../../issues)
